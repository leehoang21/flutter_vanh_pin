...
class CreateGroupChatScreenProvider extends StatelessWidget {
  const CreateGroupChatScreenProvider({super.key});

  @override
  Widget build(BuildContext context) {
    return const ProviderWidget<CreateGroupChatCubit>(
      params: [],
