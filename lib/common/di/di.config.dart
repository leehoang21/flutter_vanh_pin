...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.factoryAsync<_i606.ChatRepository>(() async =>
        _i838.ChatRepositoryImpl(await getAsync<_i585.FirebaseConfig>()));
    ...
    gh.factoryAsync<_i299.ChatCubit>(
        () async => _i299.ChatCubit(await getAsync<_i140.ChatUseCase>()));
    ...
    gh.factoryAsync<_i299.GroupDetailCubit>(() async =>
        _i299.GroupDetailCubit(await getAsync<_i652.PostUseCase>()));
    gh.factoryAsync<_i449.HomeCubit>(
        () async => _i449.HomeCubit(await getAsync<_i652.PostUseCase>()));
    ...
    gh.factoryAsync<_i217.LoginCubit>(
        () async => _i217.LoginCubit(await getAsync<_i1063.AuthUseCase>()));
